...
public class Player {
    ...
    public Image getFaceMaskFactoryImage(int width, int height) {
         ...
         */
        int lvl = getMaskProtectionLevel();
        return new Image(lvl < 20 ? "mask-1.png" :
                lvl < 50 ? "mask-2.png" :
                lvl < 80 ? "mask-3.png" : "mask-4.png",
                width,
                height,
                false,
                true);
    ...
    public Image getVaccineFactoryImage(int width, int height) {
         ...
         * hint: refer to the above getMedicationFacilityImage() method for hints on how this method could be implemented
         */
        int lvl = getVaccineLevel();
        return new Image(lvl < 20 ? "vaccine-1.png" :
                lvl < 50 ? "vaccine-2.png" :
                        lvl < 80 ? "vaccine-3.png" : "vaccine-4.png",
                width,
                height,
                false,
                true);
