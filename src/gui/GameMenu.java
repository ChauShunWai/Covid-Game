...
public class GameMenu extends VBox {
    ...
    private void initHandlers() {
        ...
        staffListView.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent mouseEvent) {
                HealthAuthorityStaff staff = staffListView.getSelectionModel().getSelectedItem();
                if(staff != null) {
                    onSelectStaff(staff);
                }
            }
    ...
    private Pane createActionButtonGroup() {
         ...
         */
        Button button1 = new Button("Develop Medication Facility");
        Button button2 = new Button("Build Mask Factory");
        Button button3 = new Button("Upgrade Mask Quality");
        Button button4 = new Button("Ban Travel");
        Button button5 = new Button("Develop Vaccine");
        Button button6 = new Button("Upgrade the Vaccine");
        Button button7 = new Button("Lift Travel Ban");
        ...
        vBoxes[1] = new VBox();
        vBoxes[2] = new VBox();
        vBoxes[0].getChildren().addAll(button1, button2, button3);
        vBoxes[1].getChildren().addAll(button4, button5, button6);
        vBoxes[2].getChildren().addAll(button7, skipButton, menuButton);
        vBoxes[0].setSpacing(10);
        vBoxes[1].setSpacing(10);
        vBoxes[2].setSpacing(10);
        HBox res = new HBox();
        res.setSpacing(10);
        res.getChildren().addAll(vBoxes[0], vBoxes[1], vBoxes[2]);
    ...
    private void actionButtonHandler(int actionNumber) {
        ...
        City city = cityListView.getSelectionModel().getSelectedItem();
        HealthAuthorityStaff staff = staffListView.getSelectionModel().getSelectedItem();
        Containment cont = containmentListView.getSelectionModel().getSelectedItem();
        gameActionHandler.handle(actionNumber, staff, city, cont);
    }
